...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">ROOM PULSA<sup></sup></div>
    </a>
    ...
    <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="index.php?page=saldo">saldo</a>
                <a class="collapse-item" href="index.php?page=pulsa">Pulsa</a>
                <a class="collapse-item" href="index.php?page=Seluler">Seluler</a>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h5 class="d-lg-block d-none mt-2"><b><?php echo $agen['nama_agen']; ?>, <?php echo $agen['alamat_agen']; ?></b></h5>
            <!-- Topbar Navbar -->
